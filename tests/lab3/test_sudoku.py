...
class SudokuTestCase(unittest.TestCase):
    ...
    def test_get_row(self):
        ...
        pos = (0, 0)
        expected_row = ["1", "2", "."]
        actual_row = sudoku.get_line_by_pos(puzzle, pos)
    ...
    def test_get_col(self):
        ...
        pos = (0, 0)
        expected_col = ["1", "4", "7"]
        actual_col = sudoku.get_column_by_pos(puzzle, pos)
    ...
    def test_get_block(self):
        ...
        actual_block = sudoku.get_square_by_pos(grid, pos)
    ...
    def test_solve(self):
        ...
        actual_solution = sudoku.get_solve(grid)
    ...
    def test_check_solution(self):
        ...
        self.assertTrue(sudoku.is_correct_answer(good_solution))
        ...
        self.assertFalse(sudoku.is_correct_answer(not_solved))
        ...
        self.assertFalse(sudoku.is_correct_answer(bad_solution))
    ...
    def test_generate_sudoku(self):
        ...
        solution = sudoku.get_solve(grid)
        solved = sudoku.is_correct_sudoku(solution)
